  ...
  return (
    <main className="mx-auto flex w-full max-w-md flex-1 flex-col px-5 pt-10 pb-safe">
      {rejected ? (
        ...
        <div className="space-y-6">
          <span className="bg-urgency-100 text-urgency-700 flex size-14 items-center justify-center rounded-2xl">
    ...
    <div className="flex gap-3">
      <span
        className={
            ...
            ? 'bg-verify-100 text-verify-700 flex size-8 shrink-0 items-center justify-center rounded-full'
            : 'bg-surface-muted flex size-8 shrink-0 items-center justify-center rounded-full text-[var(--muted)]'
        }
      >
